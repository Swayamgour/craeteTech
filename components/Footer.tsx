...
export default function Footer () {
  const socialLinks = [
    {
      icon: Facebook,
      href: 'https://www.facebook.com/RiveyraInfotech/',
      color: 'hover:text-blue-500'
    },
    {
      icon: Twitter,
      href: 'https://x.com/RiveyraInfotech',
      color: 'hover:text-blue-400'
    },
    {
      icon: Linkedin,
      href: 'https://www.linkedin.com/company/riveyrainfotechp/',
      color: 'hover:text-blue-600'
    },
    {
      icon: Instagram,
      href: 'https://www.instagram.com/RiveyraInfotech/',
      color: 'hover:text-pink-500'
    },
    {
      icon: Youtube,
      href: 'https://www.youtube.com/@riveyrainfotech',
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8'>
            ...
            >
              ...
              <p className='text-gray-300 text-sm leading-relaxed'>
                Services and Consulting company with over 8 years of proven
                excellence in the offshore IT industry. Our specialization lies
                in offering a comprehensive range of services, encompassing both
            ...
            >
              ...
              <div className='space-y-4'>
                {/* Review Image 1 */}
                <img
                  src={getAsset('/images/footer/review1.png')}
                ...
                {/* Review Image 2 */}
                <img
                  src={getAsset('/images/footer/review2.png')}
                ...
                {/* Review Image 3 */}
                <img
                  src={getAsset('/images/footer/review3.png')}
